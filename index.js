...
function nextTrack(){
    ...
    if(temp){
        ...
        if(_version=='test'){
            ...
            data['fail']=fail_ids;
            track_tool.missionReport({data,master_ip,master_port,master_name,master_version,access_token:mission['token']['access_token'],mission_status,request_timeout,master_timeout_again},(flag,msg)=>{
